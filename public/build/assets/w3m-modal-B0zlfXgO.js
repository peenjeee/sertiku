const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/index-CXR4VsLO.js","assets/web3modal-ay82gtD0.js","assets/app-bTLEhFuD.js"])))=>i.map(i=>d[i]);
import{_ as p}from"./app-bTLEhFuD.js";import{i as v,a as y,M as a,A as h,O as f,b as C,E as k,x as S,R as m,T as x,U as A,c as E,S as O,C as u,r as c,d as _}from"./web3modal-ay82gtD0.js";const L=v`
  :host {
...
`;var l=function(w,e,t,o){var r=arguments.length,i=r<3?e:o===null?o=Object.getOwnPropertyDescriptor(e,t):o,s;if(typeof Reflect=="object"&&typeof Reflect.decorate=="function")i=Reflect.decorate(w,e,t,o);else for(var d=w.length-1;d>=0;d--)(s=w[d])&&(i=(r<3?s(i):r>3?s(e,t,i):s(e,t))||i);return r>3&&i&&Object.defineProperty(e,t,i),i};const b="scroll-lock";let n=class extends y{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.open=a.state.open,this.caipAddress=h.state.caipAddress,this.isSiweEnabled=f.state.isSiweEnabled,this.connected=h.state.isConnected,this.loading=a.state.loading,this.shake=a.state.shake,this.initializeTheming(),C.prefetch(),this.unsubscribe.push(a.subscribeKey("open",e=>e?this.onOpen():this.onClose()),a.subscribeKey("shake",e=>this.shake=e),a.subscribeKey("loading",e=>{this.loading=e,this.onNewAddress(h.state.caipAddress)}),h.subscribeKey("isConnected",e=>this.connected=e),h.subscribeKey("caipAddress",e=>this.onNewAddress(e)),f.subscribeKey("isSiweEnabled",e=>this.isSiweEnabled=e)),k.sendEvent({type:"track",event:"MODAL_LOADED"})}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.open?S`
        ...
        `:null}async onOverlayClick(e){e.target===e.currentTarget&&await this.handleClose()}async handleClose(){const e=m.state.view==="ConnectingSiwe",t=m.state.view==="ApproveTransaction";if(this.isSiweEnabled){const{SIWEController:o}=await p(async()=>{const{SIWEController:i}=await import("./index-CXR4VsLO.js");return{SIWEController:i}},__vite__mapDeps([0,1,2]));o.state.status!=="success"&&(e||t)?a.shake():a.close()}else a.close()}initializeTheming(){const{themeVariables:e,themeMode:t}=x.state,o=A.getColorTheme(t);E(e,o)}onClose(){this.open=!1,this.classList.remove("open"),this.onScrollUnlock(),O.hide(),this.onRemoveKeyboardListener()}onOpen(){this.open=!0,this.classList.add("open"),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){const e=document.createElement("style");e.dataset.w3m=b,e.textContent=`
      body {
        touch-action: none;
        overflow: hidden;
