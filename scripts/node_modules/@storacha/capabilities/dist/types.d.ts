...
export type AccountUsage = InferInvokedCapability<typeof AccountUsageCaps.accountUsage>;
export type AccountUsageGet = InferInvokedCapability<typeof AccountUsageCaps.get>;
...
export type SpaceContentServe = InferInvokedCapability<typeof SpaceCaps.contentServe>;
export type SpaceEncryptionSetup = InferInvokedCapability<typeof SpaceCaps.EncryptionSetup>;
export type SpaceEncryptionKeyDecrypt = InferInvokedCapability<typeof SpaceCaps.EncryptionKeyDecrypt>;
...
export type SpaceIndexAddFailure = IndexNotFound | DecodeFailure | UnknownFormat | ShardNotFound | SliceNotFound | RetrievalAuthorizationNotFound | InvalidRetrievalAuthorization | PublishFailure | Failure;
...
export type SpaceBlobReplicate = InferInvokedCapability<typeof SpaceBlobCaps.replicate>;
/** @deprecated */
...
export type SpaceBlobAddFailure = BlobSizeOutsideOfSupportedRange | AwaitError | StorageGetError | Ucanto.Failure;
...
export type SpaceBlobReplicateFailure = ReplicationCountRangeError | ReplicationCandidateUnavailable | ReplicationSourceNotFound | InvalidReplicationSite | Failure;
...
export type PlanCreateAdminSessionFailure = AdminSessionNotSupported | CustomerNotFound | UnexpectedError;
export type PlanCreateCheckoutSession = InferInvokedCapability<typeof PlanCaps.createCheckoutSession>;
...
export type PlanCreateCheckoutSessionFailure = CustomerExists | SessionCreationError | PlanNotFound | UnexpectedError;
