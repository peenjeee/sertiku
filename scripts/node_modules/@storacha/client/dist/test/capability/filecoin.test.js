...
export const FilecoinClient = Test.withContext({
    ...
    info: {
        'should get piece info': async (assert, { client: alice, pieceStore, service, receiptStore }) => {
            ...
            assert.deepEqual(res.out.ok?.aggregates[0].aggregate.toString(), aggregate.link.toString());
