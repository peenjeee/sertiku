...
import { AccessDelegate, AccessDelegateFailure, AccessDelegateSuccess, type Service as AccessService, type AgentDataExport } from '@storacha/access/types';
import { type Service as UploadService } from '@storacha/upload-client/types';
import type { ConnectionView, Signer, DID, Ability, Resource, Unit, ServiceMethod } from '@ucanto/interface';
...
export type { Access, AccountDID, ProviderDID, SpaceDID, OwnedSpace, SharedSpace, } from '@storacha/access/types';
...
export interface ContentServeService {
    access: {
        delegate: ServiceMethod<AccessDelegate, AccessDelegateSuccess, AccessDelegateFailure>;
    };
}
...
export type { DID, Principal, Delegation, Ability, Capability, Capabilities, UCANOptions, UCANBlock, Block, ConnectionView, } from '@ucanto/interface';
export type { Abilities, ServiceAbility, SpaceBlobAdd, SpaceBlobList, SpaceBlobRemove, StoreAdd, StoreList, StoreRemove, UploadAdd, UploadList, UploadRemove, PlanGet, PlanGetSuccess, PlanGetFailure, PlanSet, PlanSetSuccess, PlanSetFailure, PlanCreateAdminSession, PlanCreateAdminSessionSuccess, PlanCreateAdminSessionFailure, FilecoinOffer, FilecoinOfferSuccess, FilecoinOfferFailure, FilecoinSubmit, FilecoinSubmitSuccess, FilecoinSubmitFailure, FilecoinAccept, FilecoinAcceptSuccess, FilecoinAcceptFailure, FilecoinInfo, FilecoinInfoSuccess, FilecoinInfoFailure, UCANAttest, AccountUsageGet, AccountUsageGetSuccess, AccountUsageGetFailure, } from '@storacha/capabilities/types';
export type { AgentDataModel, AgentDataExport, AgentMeta, DelegationMeta, } from '@storacha/access/types';
export type { SpaceBlobAddSuccess, SpaceBlobAddFailure, SpaceBlobListSuccess, SpaceBlobListFailure, SpaceBlobRemoveSuccess, SpaceBlobRemoveFailure, SpaceIndexAddSuccess, SpaceIndexAddFailure, UploadAddSuccess, UploadGetSuccess, UploadGetFailure, UploadRemoveSuccess, UploadListSuccess, UploadListItem, UsageReportSuccess, UsageReportFailure, EgressData, EgressRecord, EgressRecordSuccess, EgressRecordFailure, ListResponse, AnyLink, CARLink, CARFile, CARMetadata, Retryable, Abortable, Connectable, Pageable, RequestOptions, ListRequestOptions, ShardingOptions, ShardStoringOptions, UploadOptions, UploadFileOptions, UploadDirectoryOptions, FileLike, BlobLike, ProgressStatus, ReceiptGetOptions, } from '@storacha/upload-client/types';
