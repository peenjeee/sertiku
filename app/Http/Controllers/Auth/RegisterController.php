...
class RegisterController extends Controller
{
    ...
    public function storeLembaga(Request $request)
    {
        ...
        */
        ...
        return redirect()
            ->route('register')   // kembali ke halaman register, bisa tampilkan notifikasi hijau dari session('status')
            ->with('status', 'Data pendaftaran lembaga berhasil dikirim. Tim SertiKu akan memverifikasi data Anda.');
    }
}
