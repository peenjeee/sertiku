<x-layouts.app title="Hasil Verifikasi - SertiKu">
    ...
    @php
        ...
        $isExpired = ($certificate['status'] ?? '') === 'expired' ||
            (isset($certificate['kadaluarsa']) && $certificate['kadaluarsa'] && \Carbon\Carbon::parse($certificate['kadaluarsa'])->isPast());
                ...
                <div class="px-12 pt-16 pb-10 max-[640px]:px-6 max-[640px]:pb-8">
                    ...
                    <div class="mb-6 flex flex-col items-center gap-2 text-center">
                        ...
                        @elseif($isExpired)
                            ...
                            <p class="max-w-xl text-sm font-normal leading-relaxed text-[rgba(255,224,178,0.9)]">
                                Sertifikat ini telah melewati masa berlaku pada
                                <strong>{{ $certificate['kadaluarsa'] ?? 'tanggal tidak diketahui' }}</strong>.
                                Data sertifikat tetap valid sebagai arsip historis.
                            </p>
                        @else
