    ...
    <section class="mx-auto max-w-5xl px-4 pt-24 pb-16 flex flex-col items-center">
        <div class="mx-auto flex w-full max-w-5xl flex-col items-center gap-10">
            ...
            <section
                ...
                <div
                    class="h-3 w-full rounded-t-[24px] {{ $isRevoked ? 'bg-gradient-to-r from-[#EF4444] via-[#EF4444] to-[#F97316]' : ($isExpired ? 'bg-gradient-to-r from-[#F59E0B] via-[#F59E0B] to-[#FBBF24]' : 'bg-gradient-to-r from-[#22C55E] via-[#22C55E] to-[#38BDF8]') }}">
                </div>
                    ...
                    <div
                        ...
                        @elseif($isExpired)
                            ...
                            <div
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24" fill="none">
                                    <circle cx="12" cy="12" r="10" stroke="#FFFFFF" stroke-width="1.8" />
                                    <path d="M12 8v4l3 3" stroke="#FFFFFF" stroke-width="1.8" stroke-linecap="round"
                ...
                <div class="px-12 pt-16 pb-10 max-[640px]:px-6 max-[640px]:pb-8">
                    ...
                    <div class="mb-6 flex flex-col items-center gap-2 text-center">
                        ...
                        @elseif($isExpired)
                            <h2 class="text-base font-bold text-[#F59E0B] flex items-center gap-2">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            ...
                            <p class="max-w-xl text-sm font-normal leading-relaxed text-[rgba(255,230,200,0.9)]">
                                Sertifikat ini telah melewati masa berlakunya pada
                                <strong>{{ $certificate['kadaluarsa'] }}</strong>.
                                Sertifikat mungkin masih terverifikasi di sistem, namun tidak aktif secara resmi.
                            </p>
                        @else
                            ...
                            <div id="pdf-container" class="relative {{ $aspectRatio }} flex items-center justify-center">
                                ...
                                <div id="pdf-loading" class="absolute inset-0 flex items-center justify-center bg-gray-800">
                                    <div class="text-center">
                                        <div
                                            class="animate-spin rounded-full h-12 w-12 border-4 border-white/20 border-t-green-500 mx-auto mb-3">
                                        </div>
                        ...
                        <div class="flex flex-col lg:flex-row gap-6">
                            ...
                            <div class="flex-1">
                                ...
                                <div
                                    ...
                                    <div class="flex items-start gap-3">
                                        <span
                                            class="mt-1 h-1.5 w-1.5 rounded-full {{ $isRevoked ? 'bg-[#EF4444]' : ($isExpired ? 'bg-[#F59E0B]' : 'bg-[#22C55E]') }} print-bullet"></span>
                                        <p>
                                            <span class="font-semibold text-[#8EC5FF]">Status:</span>
                                            @if($isRevoked)
                                                <span class="ml-1 text-[#EF4444]">Dicabut</span>
                                            @elseif($isExpired)
                                                <span class="ml-1 text-[#F59E0B]">Kadaluarsa
                                                    ({{ $certificate['kadaluarsa'] }})</span>
                                            @else
                                                <span class="ml-1 text-[#15803D]">Aktif &amp; Terverifikasi</span>
                                            @endif
                                        </p>
                                    </div>
