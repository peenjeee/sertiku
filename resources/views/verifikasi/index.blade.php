...
<x-layouts.app title="Verifikasi Sertifikat – SertiKu"
    description="Verifikasi keaslian sertifikat digital secara instan. Scan QR Code atau masukkan kode hash untuk memastikan sertifikat Anda asli dan valid.">
                ...
                <div class="rounded-[24px] border border-[rgba(255,255,255,0.2)]
                    ...
                    <div class="mt-8 grid grid-cols-3 gap-4">
                        <div class="rounded-[14px] border border-[rgba(255,255,255,0.2)]
                            ...
                            <div class="text-[24px] leading-[32px] text-white">{{ $totalAccounts }}</div>
                            <div class="mt-1 text-[12px] leading-[16px] text-[#BEDBFF]">Akun Terdaftar</div>
                        </div>
                        <div class="rounded-[14px] border border-[rgba(255,255,255,0.2)]
                                   bg-[rgba(255,255,255,0.05)] px-4 py-4 text-center">
                            <div class="text-[24px] leading-[32px] text-white">{{ $totalCertificates }}</div>
                            <div class="mt-1 text-[12px] leading-[16px] text-[#BEDBFF]">Sertifikat Terbit</div>
                        </div>
                        <div class="rounded-[14px] border border-[rgba(255,255,255,0.2)]
                                   bg-[rgba(255,255,255,0.05)] px-4 py-4 text-center">
                            <div class="text-[24px] leading-[32px] text-white">{{ $totalBlockchainTransactions }}</div>
                            <div class="mt-1 text-[12px] leading-[16px] text-[#BEDBFF]">Transaksi Blockchain</div>
                        </div>
                    </div>
