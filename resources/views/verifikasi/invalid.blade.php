...
<path d="M12 17H12.01" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        ...
                        <div class="flex-1 space-y-3">
                            ...
                            <ul class="space-y-2 text-sm md:text-base">
                                <li class="relative pl-4 text-[#C10007]">
                                    <span class="absolute left-0 top-[0.7em] h-[6px] w-[6px] -translate-y-1/2 rounded-full bg-[#FB2C36]"></span>
                ...
                {{-- LANGKAH SELANJUTNYA --}}
                <div class="space-y-4">
                    <p class="text-base font-normal text-[#1C398E]">
                        Langkah Selanjutnya:
                    </p>

                    {{-- Tombol 1: Coba Verifikasi Lagi --}}
                    <a href="{{ route('verifikasi') }}"
                       class="block rounded-[8px] border border-[#BEDBFF] bg-white px-4 py-4 hover:bg-[#F9FBFF] transition-colors duration-200">
                        <div class="flex items-center gap-3">
                            <div class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-[14px] bg-[#DBEAFE]">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M9.99375 15.8234L4.16406 9.99375L9.99375 4.16406" stroke="#155DFC" stroke-width="1.66562" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M15.8234 9.99365H4.16406" stroke="#155DFC" stroke-width="1.66562" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
                    ...
                    <a href="#"
                       class="block rounded-[8px] border border-[#FFC9C9] bg-white px-4 py-4 hover:bg-[#FFF5F5] transition-colors duration-200">
                        <div class="flex items-center gap-3">
                            <div class="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-[14px] bg-[#FFE2E2]">
                               <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M18.0968 14.9906L11.4343 3.3312C11.289 3.07487 11.0783 2.86165 10.8238 2.71331C10.5692 2.56497 10.2798 2.48682 9.98517 2.48682C9.69054 2.48682 9.40117 2.56497 9.1466 2.71331C8.89202 2.86165 8.68135 3.07487 8.53608 3.3312L1.87358 14.9906C1.72674 15.2449 1.64974 15.5335 1.65039 15.8271C1.65104 16.1208 1.72932 16.4091 1.87728 16.6627C2.02525 16.9164 2.23764 17.1264 2.49294 17.2715C2.74824 17.4166 3.03736 17.4917 3.331 17.489H16.656C16.9482 17.4887 17.2352 17.4115 17.4882 17.2652C17.7412 17.1189 17.9512 16.9086 18.0972 16.6555C18.2432 16.4023 18.32 16.1152 18.3199 15.823C18.3198 15.5307 18.2429 15.2437 18.0968 14.9906Z" stroke="#E7000B" stroke-width="1.66562" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9.99365 7.49536V10.8266" stroke="#E7000B" stroke-width="1.66562" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M9.99365 14.1577H10.002" stroke="#E7000B" stroke-width="1.66562" stroke-linecap="round" stroke-linejoin="round"/>
</svg>
