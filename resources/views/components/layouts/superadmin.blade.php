@props(['title' => 'Super Admin Dashboard – SertiKu'])
...
<body class="antialiased text-white">
    ...
    <aside class="sidebar fixed left-0 top-0 h-screen flex flex-col z-50" id="sidebar">
        ...
        <div class="flex items-center gap-3 px-5 py-5 border-b border-purple-500/20">
            <div class="superadmin-badge w-10 h-10 rounded-xl flex items-center justify-center">
            ...
            <div>
                ...
                <p class="text-purple-400 text-xs">Super Admin</p>
            </div>
        </div>
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('superadmin.logs') }}" class="nav-item {{ request()->routeIs('superadmin.logs') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-4 border-t border-purple-500/20">
            <div class="flex items-center gap-3 mb-3">
                <div class="superadmin-badge w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm">
