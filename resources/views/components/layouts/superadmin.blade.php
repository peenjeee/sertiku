...
<body class="antialiased text-white">
    ...
    <aside class="sidebar fixed left-0 top-0 h-screen flex flex-col z-50" id="sidebar">
        ...
        <a href="{{ route('home') }}"
            ...
            <div
                class="superadmin-badge w-10 h-10 rounded-xl flex items-center justify-center group-hover:scale-105 transition">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('superadmin.admins') }}"
                class="nav-item {{ request()->routeIs('superadmin.admins*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
