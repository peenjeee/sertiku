...
<body class="antialiased text-white overflow-x-hidden">
    ...
    <aside class="sidebar fixed left-0 top-0 h-screen flex flex-col z-50" id="sidebar">
        ...
        <div class="user-profile-section p-4">
            ...
            <a href="{{ route('user.profil.edit') }}" class="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-white/20 text-white/70 text-sm hover:bg-white/5 transition mb-2">
            ...
            <a href="{{ route('contact.admin') }}" class="w-full flex items-center justify-center gap-2 px-4 py-2 rounded-lg border border-green-500/30 text-green-400 text-sm hover:bg-green-500/10 transition mb-2">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
