...
<head>
    ...
    <style>
        ...
        .nav-item:hover { background: rgba(139, 92, 246, 0.1); color: rgba(255, 255, 255, 0.9); }
        .nav-item.active {
        ...
        .stat-card-purple { background: linear-gradient(135deg, rgba(139, 92, 246, 0.15) 0%, rgba(168, 85, 247, 0.05) 100%); border: 1px solid rgba(139, 92, 246, 0.2); }
        ...
        @media (max-width: 1024px) {
            .sidebar { position: fixed; left: -260px; z-index: 50; height: 100vh; }
            .sidebar.open { left: 0; }
...
<body class="antialiased text-white">
    ...
    <aside class="sidebar fixed left-0 top-0 h-screen flex flex-col z-50" id="sidebar">
        {{-- Logo --}}
        <div class="flex items-center gap-3 px-5 py-5 border-b border-purple-500/20">
            <div class="master-badge w-10 h-10 rounded-xl flex items-center justify-center">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            <a href="{{ route('master.admins') }}" class="nav-item {{ request()->routeIs('master.admins*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('master.settings') }}" class="nav-item {{ request()->routeIs('master.settings') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('master.logs') }}" class="nav-item {{ request()->routeIs('master.logs') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="p-4 border-t border-purple-500/20">
            <div class="flex items-center gap-3 mb-3">
                <div class="master-badge w-10 h-10 rounded-full flex items-center justify-center text-white font-bold text-sm">
