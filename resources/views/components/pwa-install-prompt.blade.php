...
<div id="pwa-install-prompt" class="fixed bottom-4 left-4 right-4 md:left-auto md:right-4 z-50 hidden md:max-w-sm">
    <div
        ...
        <div class="flex items-start gap-4">
            {{-- App Icon --}}
            <div
                class="flex-shrink-0 w-14 h-14 bg-gradient-to-br from-[#3B82F6] to-[#8B5CF6] rounded-2xl flex items-center justify-center shadow-lg">
            ...
            <div class="flex-1 pr-4">
                ...
                <p class="text-[#8EC5FF]/70 text-sm mb-4">Tambahkan ke home screen untuk akses lebih cepat tanpa
                    browser!</p>

                {{-- Benefits --}}
                <div class="flex flex-wrap gap-2 mb-4">
                    <span
                        class="inline-flex items-center gap-1 text-xs text-[#10B981] bg-[#10B981]/10 px-2 py-1 rounded-full">
                    ...
                    <span
                        class="inline-flex items-center gap-1 text-xs text-[#3B82F6] bg-[#3B82F6]/10 px-2 py-1 rounded-full">
                        <svg class="w-3 h-3" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex gap-2">
                    <button onclick="dismissPwaPrompt()"
                        class="px-4 py-2 text-sm text-[#8EC5FF]/70 hover:text-white transition-colors">
                        Nanti
                    </button>
                    <button onclick="installPwa()"
                        class="flex-1 px-5 py-2.5 text-sm font-semibold text-white bg-gradient-to-r from-[#3B82F6] to-[#8B5CF6] rounded-xl hover:opacity-90 transition-all shadow-lg flex items-center justify-center gap-2">
...
<div id="ios-install-modal"
    ...
    <div class="bg-[#0A1628] border border-white/10 rounded-2xl p-6 max-w-sm mx-4 shadow-2xl">
        <div class="text-center mb-4">
            <div
                class="w-16 h-16 bg-gradient-to-br from-[#3B82F6] to-[#8B5CF6] rounded-2xl flex items-center justify-center mx-auto mb-4">
        ...
        <ol class="space-y-3 mb-6 text-sm text-[#BEDBFF]">
            <li class="flex items-start gap-3">
                <span
                    class="flex-shrink-0 w-6 h-6 rounded-full bg-[#3B82F6]/20 text-[#3B82F6] flex items-center justify-center text-xs font-bold">1</span>
                <span>Tap ikon <strong>Share</strong> di Safari (kotak dengan panah)</span>
            </li>
            <li class="flex items-start gap-3">
                <span
                    class="flex-shrink-0 w-6 h-6 rounded-full bg-[#3B82F6]/20 text-[#3B82F6] flex items-center justify-center text-xs font-bold">2</span>
                <span>Scroll dan pilih <strong>"Add to Home Screen"</strong></span>
            </li>
            <li class="flex items-start gap-3">
                <span
                    class="flex-shrink-0 w-6 h-6 rounded-full bg-[#3B82F6]/20 text-[#3B82F6] flex items-center justify-center text-xs font-bold">3</span>
                <span>Tap <strong>"Add"</strong> di pojok kanan atas</span>
            </li>
        </ol>

        <button onclick="closeIosModal()"
            class="w-full py-3 rounded-xl bg-gradient-to-r from-[#3B82F6] to-[#8B5CF6] text-white font-medium hover:opacity-90 transition">
            Mengerti
        </button>
    </div>
</div>
