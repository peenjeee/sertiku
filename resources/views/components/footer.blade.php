            ...
            <div>
                <div class="flex items-center gap-3">
                    <svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            ...
                            stroke="white" stroke-width="2.8793" />
                        <path
                            ...
                            stroke="white" stroke-width="1.91953" />
                        <path d="M15.5962 15.5962H25.1938" stroke="white" stroke-width="1.43965"
                            stroke-linecap="round" />
                        <path d="M15.5962 19.1953H22.7944" stroke="white" stroke-width="1.43965"
                            stroke-linecap="round" />
                        <path
                            d="M17.9957 39.1105C20.381 39.1105 22.3146 37.1769 22.3146 34.7916C22.3146 32.4063 20.381 30.4727 17.9957 30.4727C15.6104 30.4727 13.6768 32.4063 13.6768 34.7916C13.6768 37.1769 15.6104 39.1105 17.9957 39.1105Z"
                            fill="white" />
                        <path d="M17.9955 30.4727L16.3159 37.191L17.9955 35.9913L19.6751 37.191L17.9955 30.4727Z"
                            fill="white" />
                ...
                <div class="mt-4 flex items-center gap-2 text-sm text-[rgba(190,219,255,0.9)]">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                            d="M16.6668 8.33317C16.6668 12.494 12.051 16.8273 10.501 18.1657C10.3566 18.2742 10.1808 18.333 10.0002 18.333C9.8195 18.333 9.64373 18.2742 9.49933 18.1657C7.94933 16.8273 3.3335 12.494 3.3335 8.33317C3.3335 6.56506 4.03588 4.86937 5.28612 3.61913C6.53636 2.36888 8.23205 1.6665 10.0002 1.6665C11.7683 1.6665 13.464 2.36888 14.7142 3.61913C15.9645 4.86937 16.6668 6.56506 16.6668 8.33317Z"
                            stroke="#BEDBFF" stroke-opacity="0.7" stroke-width="1.66667" stroke-linecap="round"
                ...
                <div class="mt-6 flex items-center gap-3">
                    ...
                    <a href="https://instagram.com/sertiku.web.id" target="_blank"
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M14.1665 1.6665H5.83317C3.53198 1.6665 1.6665 3.53198 1.6665 5.83317V14.1665C1.6665 16.4677 3.53198 18.3332 5.83317 18.3332H14.1665C16.4677 18.3332 18.3332 16.4677 18.3332 14.1665V5.83317C18.3332 3.53198 16.4677 1.6665 14.1665 1.6665Z"
                            ...
                            <path
                                ...
                                stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M14.5835 5.4165H14.5918" stroke="white" stroke-width="1.66667"
                    ...
                    <a href="https://sertiku.web.id" target="_blank"
                        ...
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path
                                ...
                                stroke="white" stroke-width="1.66667" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M1.6665 10H18.3332" stroke="white" stroke-width="1.66667" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
