            ...
            <div class="p-3 border-t border-white/10 flex-shrink-0">
                <div class="flex gap-2 items-center">
                    <input type="text" id="adminReplyInput"
                        class="flex-1 min-w-0 rounded-xl bg-white/10 border border-white/10 px-4 py-2 text-white text-sm placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-green-500/50"
