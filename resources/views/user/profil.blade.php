...
<x-layouts.user title="Profil Saya – SertiKu">
    ...
    <div class="glass-card rounded-2xl p-5 lg:p-6 mb-6 animate-fade-in-up">
        <div class="flex flex-col sm:flex-row items-center sm:items-start gap-4">
            {{-- Avatar --}}
            <div class="w-20 h-20 lg:w-24 lg:h-24 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-3xl lg:text-4xl flex-shrink-0">
            ...
            <div class="flex-1 text-center sm:text-left">
                ...
                <div class="flex flex-wrap justify-center sm:justify-start gap-2 mt-3">
                    <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-blue-500/20 text-blue-400 text-xs">
                    ...
                    @if($user->created_at)
                    <span class="inline-flex items-center gap-1 px-3 py-1 rounded-full bg-green-500/20 text-green-400 text-xs">
                        <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="space-y-3">
            ...
            <div class="flex items-center gap-4 p-4 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 transition">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <p class="text-white/50 text-sm">{{ $cert->user->institution_name ?? $cert->user->name ?? 'Lembaga' }} • {{ $cert->issue_date?->format('d M Y') }}</p>
                </div>
