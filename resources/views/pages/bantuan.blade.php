...
<x-layouts.app title="SertiKu – Bantuan">
    ...
    <main class="min-h-screen bg-gradient-to-b from-[#0F172A] via-[#1E293B] to-[#0F172A]">
        ...
        <section class="relative overflow-hidden py-16 md:py-24">
            <div class="pointer-events-none absolute -left-32 top-0 h-96 w-96 rounded-full bg-gradient-to-r from-[#2B7FFF4D] to-[#00B8DB4D] blur-3xl opacity-60"></div>
                ...
                <div class="space-y-4">
                    ...
                    <details class="group rounded-xl bg-white/5 border border-white/10">
                        <summary class="flex cursor-pointer items-center justify-between p-5 text-white">
                            ...
                            <svg class="w-5 h-5 text-[#BEDBFF] transition group-open:rotate-180" fill="none" stroke="currentColor" viewBox="0 0 24 24">
