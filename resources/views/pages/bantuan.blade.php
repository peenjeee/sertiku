    ...
    <section class="overflow-hidden py-16 md:py-24">
        <div class="mx-auto max-w-4xl px-4 text-center relative z-10">
            ...
            <div class="mt-8 max-w-xl mx-auto">
                <div class="relative">
                    <input type="text" id="searchHelp" placeholder="Cari bantuan..." oninput="searchFAQ(this.value)"
                    ...
                    <button type="button" id="clearSearch" onclick="clearSearch()"
                        class="hidden absolute right-4 top-1/2 -translate-y-1/2 text-white/50 hover:text-white">
    ...
    <section class="py-12 px-4" id="categoriesSection">
        <div class="mx-auto max-w-5xl">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                {{-- Getting Started --}}
                <div
                    class="rounded-2xl bg-white/5 border border-white/10 p-6 hover:border-[#3B82F6]/50 transition hover-lift animate-fade-in-up stagger-1">
                    ...
                    <ul class="space-y-2 text-sm text-[#BEDBFF]/80">
                        ...
                        <li><a href="#faq-membuat-sertifikat"
                                class="hover:text-white transition flex items-center gap-2"
                                onclick="openFAQ('membuat-sertifikat')">
                                <span class="text-[#3B82F6]">→</span> Membuat sertifikat pertama
                            </a></li>
                        <li><a href="{{ route('verifikasi') }}"
                                class="hover:text-white transition flex items-center gap-2">
                ...
                {{-- Account --}}
                <div
                    class="rounded-2xl bg-white/5 border border-white/10 p-6 hover:border-[#3B82F6]/50 transition hover-lift animate-fade-in-up stagger-2">
                    ...
                    <ul class="space-y-2 text-sm text-[#BEDBFF]/80">
                        <li><a href="#faq-ubah-password" class="hover:text-white transition flex items-center gap-2"
                                onclick="openFAQ('ubah-password')">
                                <span class="text-[#10B981]">→</span> Mengubah password
                            </a></li>
                        <li><a href="#faq-login-google" class="hover:text-white transition flex items-center gap-2"
                                onclick="openFAQ('login-google')">
                                <span class="text-[#10B981]">→</span> Login dengan Google/Wallet
                            </a></li>
                        <li><a href="#faq-hapus-akun" class="hover:text-white transition flex items-center gap-2"
                                onclick="openFAQ('hapus-akun')">
                ...
                {{-- Billing --}}
                <div
                    class="rounded-2xl bg-white/5 border border-white/10 p-6 hover:border-[#3B82F6]/50 transition hover-lift animate-fade-in-up stagger-3">
                    ...
                    <ul class="space-y-2 text-sm text-[#BEDBFF]/80">
                        <li><a href="#faq-paket" class="hover:text-white transition flex items-center gap-2"
                                onclick="openFAQ('paket')">
                                <span class="text-[#F59E0B]">→</span> Paket berlangganan
                            </a></li>
                        <li><a href="#faq-metode-bayar" class="hover:text-white transition flex items-center gap-2"
                                onclick="openFAQ('metode-bayar')">
                                <span class="text-[#F59E0B]">→</span> Metode pembayaran
                            </a></li>
                        <li><a href="#faq-refund" class="hover:text-white transition flex items-center gap-2"
                                onclick="openFAQ('refund')">
    ...
    <section class="py-12 px-4" id="faqSection">
        <div class="mx-auto max-w-3xl">
            ...
            <div class="space-y-4" id="faqContainer">
                @php
                    $faqs = [
                        ...
                        // Pembayaran
                        ['id' => 'paket', 'category' => 'pembayaran', 'q' => 'Apa saja paket berlangganan yang tersedia?', 'a' => 'SertiKu menyediakan 3 paket: <br><strong>• Starter (Gratis)</strong> - 50 sertifikat/bulan, 0 Blockchain/bulan (IPFS Only)<br><strong>• Professional (Rp 599.000/bulan)</strong> - 5.000 sertifikat/bulan dengan fitur lengkap<br><strong>• Enterprise (Rp 1.000.000/bulan)</strong> - 10.000 sertifikat/bulan dengan dukungan dedicated'],
                ...
                @foreach($faqs as $index => $faq)
                    <details class="group rounded-xl bg-white/5 border border-white/10 faq-item" id="faq-{{ $faq['id'] }}"
                        data-question="{{ strtolower($faq['q']) }}" data-answer="{{ strtolower(strip_tags($faq['a'])) }}"
                        data-category="{{ $faq['category'] }}">
                        <summary class="flex cursor-pointer items-center justify-between p-5 text-white">
                            <span class="font-medium">{{ $faq['q'] }}</span>
                            <svg class="w-5 h-5 text-[#BEDBFF] transition group-open:rotate-180 flex-shrink-0 ml-2"
            ...
            <p id="noResults" class="hidden text-center text-[#BEDBFF]/60 py-8">
                Tidak ada hasil yang ditemukan. Coba kata kunci lain atau <a href="{{ route('kontak') }}"
                    class="text-[#3B82F6] hover:underline">hubungi kami</a>.
            </p>
        </div>
    </section>
        ...
        <div class="mx-auto max-w-3xl text-center">
            <div class="rounded-2xl bg-[#1E3A8F]/20 border border-[#3B82F6]/30 p-8 animate-fade-in-up">
                ...
                <div class="flex flex-col sm:flex-row gap-3 justify-center">
                    ...
                    <a href="https://wa.me/6285777419874" target="_blank"
