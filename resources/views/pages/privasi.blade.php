        ...
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="bg-white/10 rounded-2xl border border-white/20 p-8 md:p-12 text-[#DBEAFE] space-y-8">
                ...
                <section>
                    ...
                    <p class="leading-relaxed">Kami mengumpulkan informasi yang Anda berikan secara langsung kepada
                        kami, termasuk:</p>
                ...
                <section>
                    ...
                    <p class="leading-relaxed">Kami menggunakan enkripsi dan protokol keamanan standar industri untuk
                        melindungi data Anda. Data sertifikat disimpan dengan teknologi blockchain yang memastikan
                        integritas dan keamanan.</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-white mb-4">4. Berbagi Informasi</h2>
                    <p class="leading-relaxed">Kami tidak menjual atau membagikan informasi pribadi Anda kepada pihak
                        ketiga, kecuali:</p>
                    <ul class="list-disc list-inside mt-3 space-y-2 text-[#BEDBFF]">
                ...
                <section>
                    ...
                    <p class="leading-relaxed">Jika Anda memiliki pertanyaan tentang kebijakan privasi ini, silakan
                        hubungi kami melalui email di <a href="mailto:support@sertiku.web.id"
                            class="text-[#3B82F6] hover:underline">support@sertiku.web.id</a>.</p>
                </section>
            </div>
