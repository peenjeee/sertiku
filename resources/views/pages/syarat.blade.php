        ...
        <div class="max-w-4xl mx-auto px-4">
            ...
            <div class="bg-white/10 rounded-2xl border border-white/20 p-8 md:p-12 text-[#DBEAFE] space-y-8">
                ...
                <section>
                    ...
                    <p class="leading-relaxed">Dengan menggunakan layanan SertiKu, Anda menyetujui untuk terikat dengan
                ...
                <section>
                    ...
                    <p class="leading-relaxed">Semua konten, logo, dan materi pada platform SertiKu adalah milik kami
                        dan dilindungi oleh hukum hak cipta. Anda tidak boleh menyalin atau mendistribusikan tanpa izin
                        tertulis.</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-white mb-4">6. Batasan Tanggung Jawab</h2>
                    <p class="leading-relaxed">SertiKu tidak bertanggung jawab atas kerugian yang timbul dari penggunaan
                        layanan, termasuk tetapi tidak terbatas pada kehilangan data atau gangguan bisnis.</p>
                </section>

                <section>
                    <h2 class="text-xl font-semibold text-white mb-4">7. Perubahan Syarat</h2>
                    <p class="leading-relaxed">Kami berhak mengubah syarat dan ketentuan ini kapan saja. Perubahan akan
                        berlaku segera setelah dipublikasikan di platform.</p>
                </section>
