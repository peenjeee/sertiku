    ...
    <section class="mx-auto max-w-4xl px-4 py-16 lg:px-0">
        <div class="grid gap-8 lg:grid-cols-5">
            ...
            <div class="lg:col-span-3">
                <div class="rounded-[28px] border border-[rgba(255,255,255,0.14)] bg-[rgba(15,23,42,0.9)] p-6 md:p-8">
                    ...
                    <form id="checkout-form" class="mt-8 space-y-5">
                        ...
                        {{-- Error Message --}}
                        <div id="error-message" class="hidden rounded-[12px] bg-red-500/20 border border-red-500/30 p-4 text-sm text-red-300">
                        </div>
            ...
            <div class="lg:col-span-2">
                <div class="sticky top-8 rounded-[28px] border border-[rgba(255,255,255,0.14)] bg-[rgba(15,23,42,0.9)] p-6">
                    <h2 class="text-lg font-semibold text-white">Ringkasan Pesanan</h2>
                    
                    <div class="mt-6 flex items-center gap-4">
                        <div class="flex h-12 w-12 items-center justify-center rounded-[16px] bg-gradient-to-br from-[#2B7FFF] to-[#00B8DB]">
                            <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20.631 17.1825L22.6505 28.5477C22.6731 28.6815 22.6543 28.8191 22.5966 28.9419C22.539 29.0648 22.4452 29.1671 22.3278 29.2353C22.2104 29.3034 22.075 29.334 21.9397 29.3231C21.8044 29.3122 21.6757 29.2603 21.5707 29.1742L16.7986 25.5924C16.5682 25.4203 16.2883 25.3273 16.0008 25.3273C15.7132 25.3273 15.4333 25.4203 15.2029 25.5924L10.4228 29.1729C10.3179 29.2588 10.1893 29.3106 10.0542 29.3216C9.91908 29.3325 9.78384 29.3019 9.66652 29.234C9.5492 29.1661 9.45539 29.064 9.39759 28.9414C9.3398 28.8187 9.32077 28.6814 9.34305 28.5477L11.3612 17.1825" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M15.9961 18.6621C20.4133 18.6621 23.9941 15.0813 23.9941 10.6641C23.9941 6.24686 20.4133 2.66602 15.9961 2.66602C11.5789 2.66602 7.99805 6.24686 7.99805 10.6641C7.99805 15.0813 11.5789 18.6621 15.9961 18.6621Z" stroke="white" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <div>
