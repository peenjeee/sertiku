    ...
    <section class="mx-auto max-w-2xl px-4 py-16 lg:px-0">
        <div class="rounded-[28px] border border-[rgba(255,255,255,0.14)] bg-[rgba(15,23,42,0.9)] p-8">
            ...
            <div class="text-center">
                <div class="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-[#8B5CF6] to-[#EC4899]">
            ...
            {{-- Success Message --}}
            @if(session('success'))
            <div class="mt-6 rounded-[12px] bg-[#05DF72]/20 border border-[#05DF72]/30 p-4 text-center text-sm text-[#05DF72]">
                {{ session('success') }}
            </div>
            @endif
