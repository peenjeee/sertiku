        ...
        <div class="relative w-full max-w-4xl">
            ...
            <div class="relative mx-auto max-w-3xl text-white">
                ...
                <div class="text-center mb-8">
                    ...
                    {{-- Account type switch --}}
                    <div class="mt-6 inline-flex items-center rounded-lg border border-white/10 bg-white/[0.04] px-1 py-1">
                        <button type="button" id="personalTabBtn"
                        ...
                        <button type="button" id="institutionTabBtn"
                                onclick="switchAccountType('institution')"
                ...
                <div class="mb-6 flex justify-center">
                    @if($user->hasGoogleLogin())
                        <div class="inline-flex items-center gap-2 rounded-full bg-white/10 px-4 py-2 text-sm text-[#BEDBFF]">
                    ...
                    <form action="{{ route('onboarding.store') }}" method="POST" id="onboardingForm">
                        ...
                        <div id="institutionForm" class="hidden space-y-6">
                            ...
                            <div id="instStep1" class="space-y-6">
                                ...
                                <div class="space-y-2">
                                    <label class="text-sm">Website <span class="text-xs text-white/50">(Opsional)</span></label>
                                ...
                                <div class="space-y-2">
                                    <label class="text-sm">Deskripsi <span class="text-xs text-white/50">(Opsional)</span></label>
                        ...
                        <div id="personalSubmit" class="mt-6 flex items-center justify-between border-t border-white/10 pt-6">
