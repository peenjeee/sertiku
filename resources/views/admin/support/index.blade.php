                ...
                <tbody class="divide-y divide-white/5">
                    ...
                    <tr class="hover:bg-white/5 transition">
                        ...
                        <td class="py-4 px-5">
                            ...
                            <span class="inline-flex items-center px-2 py-0.5 rounded-full bg-red-500 text-white text-xs mt-1">
                        ...
                        <td class="py-4 px-5">
                            ...
                            <span class="px-2 py-1 rounded-full bg-yellow-500/20 text-yellow-400 text-xs">In Progress</span>
                            @else
                        ...
                        <td class="py-4 px-5">
                            <span class="text-white/50 text-sm">{{ $ticket->last_message_at?->diffForHumans() ?? '-' }}</span>
                        </td>
                        <td class="py-4 px-5">
