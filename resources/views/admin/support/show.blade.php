    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex items-center justify-between mb-6 animate-fade-in-up">
            <div class="flex items-center gap-4">
                <a href="{{ route('admin.support.index') }}" class="p-2 rounded-lg bg-white/10 text-white/70 hover:bg-white/20 transition">
        ...
        <div class="glass-card rounded-2xl overflow-hidden animate-fade-in-up">
            ...
            {{-- Reply Form --}}
            @if($ticket->status !== 'closed')
            <form action="{{ route('admin.support.reply', $ticket) }}" method="POST" class="p-4 border-t border-white/10">
                @csrf
