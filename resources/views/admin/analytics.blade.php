<x-layouts.admin>
    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8 animate-fade-in">
        ...
        <div class="flex items-center gap-3">
            <select class="bg-white/10 border border-white/20 text-white rounded-lg px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                <option value="7" class="text-gray-800">7 Hari Terakhir</option>
                <option value="30" selected class="text-gray-800">30 Hari Terakhir</option>
                <option value="90" class="text-gray-800">90 Hari Terakhir</option>
            </select>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-8">
        ...
        <div class="stat-card-blue rounded-2xl p-5 hover-lift animate-fade-in-up stagger-1">
            ...
            <p class="text-gray-800 text-3xl font-bold mb-2">{{ number_format($stats['total_verifikasi']['value']) }}</p>
        ...
        <div class="stat-card-green rounded-2xl p-5 hover-lift animate-fade-in-up stagger-2">
            ...
            <p class="text-gray-800 text-3xl font-bold mb-2">{{ number_format($stats['sertifikat_aktif']['value']) }}</p>
            <div class="flex items-center gap-1">
        ...
        <div class="stat-card-purple rounded-2xl p-5 hover-lift animate-fade-in-up stagger-3">
            ...
            <p class="text-gray-800 text-3xl font-bold mb-2">{{ number_format($stats['lembaga_terdaftar']['value']) }}</p>
            <div class="flex items-center gap-1">
    ...
    <div class="glass-card rounded-2xl p-6 animate-fade-in">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <span class="flex items-center gap-1 px-2 py-1 bg-emerald-100 text-emerald-700 text-xs font-medium rounded-full">
        ...
        <div class="space-y-3 max-h-64 overflow-y-auto" id="realtimeLog">
            ...
            <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg animate-slide-in-left" style="animation-delay: {{ $index * 0.1 }}s">
                <div class="flex items-center gap-3">
