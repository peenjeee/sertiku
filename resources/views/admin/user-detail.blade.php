    ...
    <div class="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8 animate-fade-in">
        <div>
            <nav class="flex items-center gap-2 text-sm mb-2">
                <a href="{{ route('admin.users') }}" class="text-white/60 hover:text-white transition">Kelola Pengguna</a>
        ...
        <a href="{{ route('admin.users') }}" class="px-4 py-2 bg-white/10 hover:bg-white/20 text-white rounded-lg transition inline-flex items-center gap-2">
        ...
        <div class="glass-card rounded-2xl p-6 animate-fade-in-up">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    @else
                    <span class="px-3 py-1 bg-gray-100 text-gray-500 text-sm font-medium rounded-full">Tidak Aktif</span>
                    @endif
                </div>
            </div>
        </div>
