    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="glass-card rounded-2xl p-6 animate-fade-in-up stagger-1">
            <div class="text-center">
                <div class="w-24 h-24 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center text-white font-bold text-3xl mx-auto mb-4">
                    {{ strtoupper(substr($admin->name, 0, 1)) }}
                </div>
                <h2 class="text-gray-800 font-bold text-xl">{{ $admin->name }}</h2>
                <p class="text-gray-500 text-sm">{{ $admin->email }}</p>
                <span class="inline-block mt-3 px-3 py-1 bg-blue-100 text-blue-700 text-xs font-medium rounded-full">Administrator</span>
            </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="glass-card rounded-2xl p-6 animate-fade-in-up stagger-3">
                ...
                <form method="POST" action="{{ route('admin.profile.password') }}" class="space-y-5">
                    ...
                    <button type="submit" class="w-full py-3 bg-orange-600 hover:bg-orange-700 text-white font-medium rounded-lg transition">
                        Ubah Password
                    </button>
                </form>
            </div>
