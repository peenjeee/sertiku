<x-layouts.admin>
    ...
    <div class="glass-card rounded-2xl p-4 mb-6 animate-fade-in">
        <form method="GET" class="flex flex-col md:flex-row gap-4">
            ...
            <select name="type" class="px-4 py-3 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <select name="status" class="px-4 py-3 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
                ...
                <tbody>
                    ...
                    <tr class="border-b border-gray-50 hover:bg-gray-50 transition">
                        ...
                        <td class="py-4 px-4">
                            ...
                            @else
                            <span class="px-2 py-1 bg-gray-100 text-gray-500 text-xs font-medium rounded-full">Tidak Aktif</span>
                            @endif
                        </td>
                        <td class="py-4 px-4">
                            <div class="flex items-center gap-2">
