                    ...
                    <div id="send-email-option" class="hidden">
                        <div class="flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-xl">
                            <label class="relative inline-flex items-center cursor-pointer mt-0.5">
                                ...
                                <div
                                    class="w-10 h-5 bg-gray-300 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600">
                                </div>
                            </label>
                            <div class="flex-1">
