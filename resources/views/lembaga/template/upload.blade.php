<x-layouts.lembaga>
    <div class="space-y-6">
        ...
        <div>
            ...
            <p class="text-white/70 text-sm lg:text-base mt-1">Upload template sertifikat untuk digunakan dalam penerbitan</p>
        </div>
        ...
        <!-- Upload Form -->
        <form action="{{ route('lembaga.template.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('lembaga.template.index') }}" class="px-8 py-4 bg-white/10 border border-white/20 rounded-xl text-white text-sm font-bold hover:bg-white/20 transition">
                    Batal
                </a>
            </div>
        </form>
