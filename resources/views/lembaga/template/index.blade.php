    ...
    <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
            ...
            <div class="glass-card rounded-2xl overflow-hidden group hover:shadow-lg transition">
                <!-- Template Preview -->
                <div class="relative aspect-[4/3] bg-gradient-to-br from-slate-700 to-slate-800 flex items-center justify-center">
                    ...
                    <div class="text-center p-4">
                        ...
                        <p class="text-white/50 text-sm">{{ strtoupper(pathinfo($template->file_path, PATHINFO_EXTENSION)) }}</p>
                    </div>
                    @endif
                    ...
                    <div class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition flex items-center justify-center gap-3">
                        ...
                        <form action="{{ route('lembaga.template.toggle', $template) }}" method="POST" class="inline">
                            @csrf
                            <button type="submit" class="w-10 h-10 bg-amber-500 rounded-full flex items-center justify-center text-white hover:bg-amber-600 transition">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
