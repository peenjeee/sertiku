{{-- resources/views/auth/master-login.blade.php --}}
<!DOCTYPE html>
<html lang="id">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Master Login – SertiKu</title>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="warning-strip rounded-t-2xl py-2 px-4 border border-purple-500/30 border-b-0">
                <div class="flex items-center justify-center gap-2 text-purple-400 text-xs">
                    ...
                    <span class="font-medium">AREA TERBATAS • HANYA UNTUK MASTER</span>
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                    </svg>
                </div>
            ...
            <div class="login-card rounded-b-2xl rounded-t-none p-8">
                ...
                <div class="text-center mb-8">
                    <div class="master-badge w-20 h-20 rounded-2xl mx-auto mb-4 flex items-center justify-center">
                        <svg class="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/>
                        </svg>
                    </div>
                    <h1 class="text-2xl font-bold text-white mb-1">Master Portal</h1>
                ...
                {{-- Login Form --}}
                <form action="{{ route('master.login.submit') }}" method="POST" class="space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" name="email" value="{{ old('email') }}"
                                   ...
                                   placeholder="master@sertiku.web.id" required autofocus>
                        </div>
                    </div>
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('home') }}" class="text-white/40 text-sm hover:text-white/70 transition flex items-center justify-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
