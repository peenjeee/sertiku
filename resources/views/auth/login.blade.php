...
<path d="M47.9953 6.39941H15.9984C10.697 6.39941 6.39935 10.6971 6.39935 15.9985V47.9953C6.39935 53.2968 10.697 57.5944 15.9984 57.5944H47.9953C53.2967 57.5944 57.5943 53.2968 57.5943 47.9953V15.9985C57.5943 10.6971 53.2967 6.39941 47.9953 6.39941Z" stroke="white" stroke-width="3.83962"/>
<path d="M45.4356 14.3987H18.5582C17.1445 14.3987 15.9984 15.5447 15.9984 16.9584V35.8366C15.9984 37.2503 17.1445 38.3963 18.5582 38.3963H45.4356C46.8493 38.3963 47.9953 37.2503 47.9953 35.8366V16.9584C47.9953 15.5447 46.8493 14.3987 45.4356 14.3987Z" stroke="white" stroke-width="2.55975"/>
<path d="M20.7979 20.7979H33.5967" stroke="white" stroke-width="1.91981" stroke-linecap="round"/>
<path d="M20.7979 25.5974H30.397" stroke="white" stroke-width="1.91981" stroke-linecap="round"/>
<path d="M23.9977 52.1549C27.1785 52.1549 29.7571 49.5763 29.7571 46.3954C29.7571 43.2146 27.1785 40.636 23.9977 40.636C20.8168 40.636 18.2382 43.2146 18.2382 46.3954C18.2382 49.5763 20.8168 52.1549 23.9977 52.1549Z" fill="white"/>
<path d="M23.9977 40.636L21.7579 49.5951L23.9977 47.9953L26.2374 49.5951L23.9977 40.636Z" fill="white"/>
...
<path d="M42.5559 34.8765H41.276V36.1563H42.5559V34.8765Z" fill="#1F3A5F"/>
                        ...
                        <!-- Description -->
                        <p class="text-xl text-[#BEDBFF]">Platform Verifikasi Sertifikat Digital Terpercaya</p>
                    </div>
                ...
                <div class="w-full max-w-[552px] mx-auto">
                    <div class="bg-white/10 border border-white/20 rounded-3xl p-10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)]">
                        ...
                        <div class="bg-white/5 border border-white/10 rounded-lg p-1 mb-8 flex">
                            <button onclick="switchTab('email')" id="emailTabBtn" class="flex-1 flex items-center justify-center gap-3 px-6 py-2 text-sm rounded-md transition-all"
                                ...
                                <svg class="w-4 h-4" viewBox="0 0 16 16" fill="none">
                                    <rect x="2" y="4" width="12" height="9" rx="1" stroke="currentColor" stroke-width="1.33"/>
                                    <path d="M2 6l6 4 6-4" stroke="currentColor" stroke-width="1.33"/>
                                </svg>
                                <span>Email</span>
                            </button>
                            <button onclick="switchTab('wallet')" id="walletTabBtn" class="flex-1 flex items-center justify-center gap-3 px-6 py-2 text-sm text-white/70 rounded-md transition-all">
                                <svg class="w-4 h-4" viewBox="0 0 16 16" fill="none">
                                    <path d="M2 2h12v7H2z" stroke="currentColor" stroke-width="1.33"/>
                                    <rect x="2" y="3.33" width="12" height="10.67" rx="1.33" stroke="currentColor" stroke-width="1.33"/>
                                </svg>
                                <span>Wallet</span>
                            </button>
                        </div>
                        ...
                        <div class="space-y-6" id="emailTab">
                                ...
                                <div class="flex gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <ul class="text-xs text-[#BEDBFF]/90 space-y-1.5 leading-relaxed">
                                            <li><span class="font-semibold">• Lembaga/Instansi?</span> Gunakan akun Google lembaga/instansi</li>
                                            <li><span class="font-semibold">• Untuk user publik?</span> Gunakan Email Biasa</li>
                                            <li><span class="font-semibold">• Support login Web3</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <!-- Google Login Button -->
                            <div class="space-y-4">
                                <a href="{{ route('google.redirect')}}" class="w-full bg-white hover:bg-gray-100 rounded-xl p-4 transition-all flex items-center justify-center gap-3 shadow-lg">
                            ...
                            <!-- <div class="flex justify-center items-center text-sm pt-2"> -->
                                <!-- <a href="#" class="text-[#8EC5FF] hover:text-[#BEDBFF] transition-colors font-semibold">Lupa Password?</a> -->
                                <!-- <a href="#" class="text-[#8EC5FF] hover:text-[#BEDBFF] transition-colors flex items-center gap-1  font-semibold">
                                   <svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_35_541)">
<path d="M8 10.5V9.5C8 8.96957 7.78929 8.46086 7.41421 8.08579C7.03914 7.71071 6.53043 7.5 6 7.5H3C2.46957 7.5 1.96086 7.71071 1.58579 8.08579C1.21071 8.46086 1 8.96957 1 9.5V10.5" stroke="#8EC5FF" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M4.5 5.5C5.60457 5.5 6.5 4.60457 6.5 3.5C6.5 2.39543 5.60457 1.5 4.5 1.5C3.39543 1.5 2.5 2.39543 2.5 3.5C2.5 4.60457 3.39543 5.5 4.5 5.5Z" stroke="#8EC5FF" stroke-linecap="round" stroke-linejoin="round"/>
...
<rect width="12" height="12" fill="white"/>
                            ...
                            <!-- </div> -->
                              <div class="mt-6.5 text-center text-sm text-gray-500">
            <p>Dengan login, Anda menyetujui</p>
            <p><a href="#" class="text-white hover:text-blue-600 hover:underline">Syarat & Ketentuan</a> dan <a href="#" class="text-white hover:text-blue-600 hover:underline">Kebijakan Privasi</a></p>
        </div>
                        </div>
                        ...
                        <div class="space-y-6" id="walletTab" style="display: none;">
                            <!-- Info Box -->
                            <!-- <div class="bg-[#1E3A8F]/30 border border-[#3B82F6]/30 rounded-2xl p-5">
                                <div class="flex gap-3">
                                    <svg class="w-5 h-5 text-[#8EC5FF] flex-shrink-0 mt-0.5" viewBox="0 0 20 20" fill="none">
                                        <circle cx="10" cy="10" r="8.33" stroke="currentColor" stroke-width="1.67"/>
                                        <line x1="10" y1="10" x2="10" y2="6.67" stroke="currentColor" stroke-width="1.67"/>
                                    ...
                                    <div class="flex-1">
                                        <p class="text-sm text-white">Klik tombol di bawah untuk menghubungkan MetaMask wallet Anda.</p>
                                    </div>
                                </div>
                            </div> -->
                            ...
                            <div class="space-y-3">
                                <!-- MetaMask -->
                                <button class="w-full bg-white/5 border border-[#FF6900]/30 rounded-lg p-4 hover:bg-white/10 transition-all group">
                                    <div class="flex items-center gap-4">
                                        <div class="flex-shrink-0 w-12 h-12 rounded-[14px] flex items-center justify-center"
...
<path d="M3 5V19C3 19.5304 3.21071 20.0391 3.58579 20.4142C3.96086 20.7893 4.46957 21 5 21H20C20.2652 21 20.5196 20.8946 20.7071 20.7071C20.8946 20.5196 21 20.2652 21 20V16" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                                        ...
                                        <div class="flex-1 text-left">
                                            ...
                                            <p class="text-sm text-[#BEDBFF]/70">MetaMask tidak terdeteksi - klik untuk install</p>
                                        </div>
                                    </div>
                                </button>
                            ...
                            <div class="bg-[#1E3A8F]/30 border border-[#3B82F6]/30 rounded-[14px] p-4">
                                <div class="flex gap-3">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-xs text-[#BEDBFF]/70 leading-relaxed">Login dengan wallet memberikan keamanan ekstra dan kontrol penuh atas identitas digital Anda.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    @if(session('success'))
    <script>
        // Toast notification di pojok kanan atas untuk logout success
