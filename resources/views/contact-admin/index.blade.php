...
<x-dynamic-component :component="$layoutComponent" :title="'Hubungi Admin – SertiKu'">
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="rounded-2xl p-6 mb-6 animate-fade-in-up" style="background: linear-gradient(180deg, #0F172A 0%, #1E293B 100%); border: 1px solid rgba(255,255,255,0.1);">
            ...
            <form action="{{ route('contact.admin.create') }}" method="POST">
                ...
                <button type="submit" class="w-full sm:w-auto px-6 py-3 rounded-xl bg-gradient-to-r from-green-500 to-emerald-600 text-white font-medium hover:opacity-90 transition">
                    Kirim Tiket
                </button>
            </form>
        </div>
        ...
        {{-- My Tickets List --}}
        <div class="rounded-2xl overflow-hidden animate-fade-in-up" style="background: linear-gradient(180deg, #0F172A 0%, #1E293B 100%); border: 1px solid rgba(255,255,255,0.1);">
                    ...
                    <div class="flex items-start justify-between gap-4">
                        <div class="flex-1 min-w-0">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                <span class="px-2 py-0.5 rounded-full bg-red-500 text-white text-xs">{{ $ticket->unread_count }} baru</span>
                                @endif
                            </div>
                        ...
                        <svg class="w-5 h-5 text-white/30 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
