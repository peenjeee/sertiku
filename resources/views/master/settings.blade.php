    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="glass-card rounded-2xl p-6 animate-fade-in-up">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between py-2 border-b border-white/10">
                    ...
                    <span class="text-white text-sm">{{ config('blockchain.chain_id') == '80002' ? 'Polygon Amoy (Testnet)' : 'Polygon Mainnet' }}</span>
                </div>
                <div class="flex items-center justify-between py-2">
                    <span class="text-white/70 text-sm">Wallet</span>
                    <span class="text-white/50 text-xs font-mono">{{ config('blockchain.wallet_address') ? substr(config('blockchain.wallet_address'), 0, 10) . '...' : 'Belum dikonfigurasi' }}</span>
                </div>
                <a href="{{ route('master.blockchain') }}" class="block text-center mt-4 px-4 py-2 rounded-xl bg-blue-500/20 text-blue-400 text-sm hover:bg-blue-500/30 transition">
        ...
        <div class="glass-card rounded-2xl p-6 animate-fade-in-up">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-center justify-between py-2 border-b border-white/10">
                    ...
                    <span class="text-white/50 text-sm">{{ config('mail.from.address') ?: 'Belum dikonfigurasi' }}</span>
                </div>
                <div class="flex items-center justify-between py-2">
        ...
        <div class="glass-card rounded-2xl p-6 animate-fade-in-up lg:col-span-2">
            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                ...
                <div class="p-4 rounded-xl bg-{{ config('blockchain.enabled') ? 'green' : 'yellow' }}-500/10 border border-{{ config('blockchain.enabled') ? 'green' : 'yellow' }}-500/20 text-center">
                    <p class="text-{{ config('blockchain.enabled') ? 'green' : 'yellow' }}-400 text-2xl font-bold">{{ config('blockchain.enabled') ? '✓' : '!' }}</p>
