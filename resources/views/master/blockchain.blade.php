{{-- resources/views/master/blockchain.blade.php --}}
<x-layouts.master title="Blockchain Wallet – Master SertiKu">
            ...
            <div class="flex items-start gap-3">
                ...
                <div>
                    ...
                    <p class="text-yellow-300/70 text-sm mt-1">
                        Saldo wallet Anda kurang dari 0.1 MATIC. Segera top up untuk melanjutkan penerbitan sertifikat
                        blockchain.
                    </p>
        ...
        <div class="glass-card rounded-2xl p-5 animate-fade-in-up">
            ...
            <div class="space-y-3">
                ...
                <div class="flex justify-between items-center py-2 border-b border-white/10">
                    ...
                    <span
                        class="text-white/80 text-xs font-mono truncate max-w-[200px]">{{ $walletInfo['rpc_url'] }}</span>
                </div>
                <div class="flex justify-between items-center py-2 border-b border-white/10">
                    <span class="text-white/60 text-sm">Explorer</span>
                    <a href="{{ $walletInfo['explorer_url'] }}" target="_blank"
                            ...
                            <tr class="border-b border-white/5 hover:bg-white/5">
                                ...
                                <td class="py-3 px-2">
                                    <a href="{{ $walletInfo['explorer_url'] }}/tx/{{ $cert->blockchain_tx_hash }}"
                                        target="_blank" class="text-purple-400 text-xs font-mono hover:underline">
